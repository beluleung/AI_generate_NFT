...
class Trainer:
    ...
    def save_model(self, model, epoch_num):
        model.save(f'gan_train_guttercatgang_E{epoch_num}', save_format='tf')
        print(f'saved gan_train_guttercatgang_E{epoch_num}')
    ...
    def pred_images_and_save(self, model, test_input):
        ...
        for i in range(predictions.shape[0]):
            ...
            plt.axis('off')
        plt.savefig('Predicted_guttercatgang.jpg')
        print('saved Predicted_guttercatgang.jpg')
    ...
    def train(self):
        ...
        plt.legend()
        plt.savefig('Losses_guttercatgang.jpg')
...
if __name__ == "__main__":
    trainer = Trainer()
    print('Trainer ready')
    trainer.get_train_dataset('/home/jiayingliang1420/clean_guttercatgang_3000_res')
    trainer.launch_GAN()
    trainer.train()
